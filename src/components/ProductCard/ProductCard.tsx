...
export function ProductCard({ product, dataTour, onSelect }: ProductCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0 flex flex-col">
        ...
        <h3 className="text-[13px] font-extrabold uppercase leading-snug mb-1 line-clamp-2 min-h-9">
          <Highlight attribute="name" hit={product} />
        </h3>
        <p className="text-xs text-body leading-relaxed mb-2 line-clamp-2 min-h-9.75">
